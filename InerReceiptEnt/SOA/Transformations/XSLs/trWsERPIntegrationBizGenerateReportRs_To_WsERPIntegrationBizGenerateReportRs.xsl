...
<xsl:stylesheet version="1.0"
                ...
                xmlns:ns0="http://soa.estrellaroja.com.mx/ERPIntegrationBiz"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="WSDL">
        ...
        <oracle-xsl-mapper:rootElement name="GenerateReportRs"
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [MON DEC 11 12:15:26 CST 2017].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:variable name="varRsTemp"/>
  <xsl:template match="/">
    <ns0:GenerateReportRs>
      <ns0:Return>
        <ns0:xmlOut>
          <ns0:xml>
            <xsl:value-of select="str:replaceAll(/ns0:GenerateReportRs/ns0:Return/ns0:xmlOut/ns0:xml,'&lt;Q_CUSTOMER>','&lt;Q_CUSTOMER xmlns=&quot;http://soa.estrellaroja.com.mx/StructureCash&quot;>')"/>
          </ns0:xml>
        </ns0:xmlOut>
      </ns0:Return>
    </ns0:GenerateReportRs>
