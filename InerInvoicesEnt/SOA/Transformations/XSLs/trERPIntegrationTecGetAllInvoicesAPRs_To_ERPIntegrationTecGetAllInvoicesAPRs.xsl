...
<xsl:stylesheet version="1.0"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [WED DEC 13 09:11:45 CST 2017].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:GenerateReportRs>
      ...
      <ns0:xmlOut>
        <ns0:xml>
          <xsl:value-of select="str:replaceAll(/ns0:GenerateReportRs/ns0:Return/ns0:xmlOut/ns0:xml,'&lt;G_INVOICES>','&lt;G_INVOICES xmlns=&quot;http://soa.estrellaroja.com.mx/InvoicesAP&quot;>')"/>
        </ns0:xml>
        </ns0:xmlOut>
      </ns0:Return>
    </ns0:GenerateReportRs>
