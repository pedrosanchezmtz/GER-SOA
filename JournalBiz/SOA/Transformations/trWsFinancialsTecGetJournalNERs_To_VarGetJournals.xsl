...
<xsl:stylesheet version="1.0"
                ...
                xmlns:ns0="http://soa.estrellaroja.com.mx/FinancialsTec"
                ...
                xmlns:ns3="http://TargetNamespace.com/ServiceName" xmlns:ns1="http://soa.estrellaroja.com.mx/JournalBiz"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [TUE JAN 02 12:18:46 CST 2018].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:template match="/">
    <ns0:GetJournalRs>
      <xsl:if test="/ns0:GetJournalNERs/ns4:Success">
        <ns4:Success>
          <xsl:value-of select="/ns0:GetJournalNERs/ns4:Success"/>
        </ns4:Success>
      </xsl:if>
      <xsl:if test="/ns0:GetJournalNERs/ns4:Errors">
        <ns4:Errors>
          <xsl:for-each select="/ns0:GetJournalNERs/ns4:Errors/ns4:Error">
            <ns4:Error>
              <ns4:ErrorCode>
      ...
      <xsl:if test="/ns0:GetJournalNERs/ns0:Return">
        <ns0:Return>
          <xsl:for-each select="/ns0:GetJournalNERs/ns0:Return/ns0:Journals">
            <ns0:Journals>
              <ns0:StatusCode>
