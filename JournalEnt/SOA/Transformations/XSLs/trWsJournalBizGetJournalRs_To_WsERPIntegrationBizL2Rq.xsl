   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         ...
         <oracle-xsl-mapper:source type="WSDL">
            ...
            <oracle-xsl-mapper:rootElement name="varInterfaceL2" namespace="http://soa.estrellaroja.com.mx/JournalEnt"/>
            <oracle-xsl-mapper:param name="varInterfaceL2"/>
         </oracle-xsl-mapper:source>
      </oracle-xsl-mapper:mapSources>
      ...
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [MON DEC 18 13:17:29 CST 2017].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:param name="varInterfaceL2"/>
   <xsl:template match="/">
      <tns:ImportToERPCloudRq>
         <tns:TargetInterface>
            <xsl:value-of select="$varInterfaceL2/ns4:varInterfaceL2"/>
         </tns:TargetInterface>
         <tns:File>
            <tns:Content>
               <xsl:value-of select="/ns0:GetJournalRs/ns0:Return/ns0:Result[2]/ns0:FileContent"/>
            </tns:Content>
            <tns:FileName>
               <xsl:value-of select="/ns0:GetJournalRs/ns0:Return/ns0:Result[2]/ns0:FileName"/>
            </tns:FileName>
         </tns:File>
      </tns:ImportToERPCloudRq>
   </xsl:template>
