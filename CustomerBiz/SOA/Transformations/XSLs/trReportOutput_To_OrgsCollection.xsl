   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="WSDL">
            ...
            <oracle-xsl-mapper:rootElement name="DATA_DS" namespace="http://soa.estrellaroja.com.mx/CoherenceTec"/>
      ...
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [THU DEC 14 17:15:56 CST 2017].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <ns0:DATA_DS>
         <xsl:for-each select="/ns0:DATA_DS/G_ORGS">
            <ns0:G_ORGS>
               <ns0:SET_ID>
                  <xsl:value-of select="SET_ID"/>
               </ns0:SET_ID>
               <ns0:SET_CODE>
                  <xsl:value-of select="SET_CODE"/>
               </ns0:SET_CODE>
               <ns0:SET_NAME>
