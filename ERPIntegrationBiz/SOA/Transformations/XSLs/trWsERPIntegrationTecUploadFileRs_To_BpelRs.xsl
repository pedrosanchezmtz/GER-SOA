   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="WSDL">
            ...
            <oracle-xsl-mapper:rootElement name="UploadFileRs" namespace="http://soa.estrellaroja.com.mx/ERPIntegrationTec"/>
      ...
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [WED JUL 12 12:14:57 CDT 2017].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <tns:ImportToERPCloudRs>
         <xsl:if test="/ns0:UploadFileRs/ns1:Success">
            <ns1:Success>
               <xsl:value-of select="/ns0:UploadFileRs/ns1:Success"/>
            </ns1:Success>
         </xsl:if>
         <xsl:if test="/ns0:UploadFileRs/ns1:Errors">
            <ns1:Errors>
               <xsl:for-each select="/ns0:UploadFileRs/ns1:Errors/ns1:Error">
                  <ns1:Error>
                     <ns1:ErrorCode>
         ...
         <xsl:if test="/ns0:UploadFileRs/ns0:Return"/>
      </tns:ImportToERPCloudRs>
   </xsl:template>
</xsl:stylesheet>