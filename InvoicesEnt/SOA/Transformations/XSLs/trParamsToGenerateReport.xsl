   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="WSDL">
            ...
            <oracle-xsl-mapper:rootElement name="ParamsInterfaceControl" namespace="http://soa.estrellaroja.com.mx/StructureTrxInterface"/>
      ...
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [THU JAN 25 00:29:11 CST 2018].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <tns:GenerateReportRq>
         <tns:TargetInterface>
            <xsl:value-of select='"InterfaceControl"'/>
         </tns:TargetInterface>
         <tns:IntegrationName>
            <xsl:value-of select="&quot;InterfacceAutoInvoiceImport&quot;"/>
         </tns:IntegrationName>
         <tns:ProcessName>
            <xsl:value-of select="&quot;CreateInvoices&quot;"/>
         </tns:ProcessName>
         <tns:ReportName>
            <xsl:value-of select='"XXER_FND_INTERFACE_CONTROL.xdm"'/>
         </tns:ReportName>
         <tns:parameterNameValues>
            <xsl:for-each select="/ns0:ParamsInterfaceControl/ns0:Params">
               <tns:item>
                  <tns:name>
