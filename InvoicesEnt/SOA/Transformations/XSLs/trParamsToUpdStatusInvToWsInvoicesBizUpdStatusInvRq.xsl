   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="WSDL">
            ...
            <oracle-xsl-mapper:rootElement name="ParamsToUpdateStatusInvoicesToBD" namespace="http://soa.estrellaroja.com.mx/StructureTrxInterface"/>
      ...
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [THU FEB 01 20:46:37 CST 2018].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <tns:UpdateStatusInvoicesRq>
         <xsl:for-each select="/ns0:ParamsToUpdateStatusInvoicesToBD/ns0:elements">
            <tns:ListElements>
               <tns:BatchId>
