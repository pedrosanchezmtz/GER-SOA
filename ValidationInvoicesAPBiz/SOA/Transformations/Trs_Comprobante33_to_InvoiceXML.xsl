...
<xsl:stylesheet version="1.0" xmlns:mhdr="http://www.oracle.com/XSL/Transform/java/oracle.tip.mediator.service.common.functions.MediatorExtnFunction" xmlns:ns1="http://www.sat.gob.mx/cfd/3" xmlns:oraext="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.ExtFunc" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xp20="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.Xpath20" xmlns:xref="http://www.oracle.com/XSL/Transform/java/oracle.tip.xref.xpath.XRefXPathFunctions" xmlns:socket="http://www.oracle.com/XSL/Transform/java/oracle.tip.adapter.socket.ProtocolTranslator" xmlns:ns0="http://soa.estrellaroja.com.mx/ValidationInvoicesAPBiz" xmlns:oracle-xsl-mapper="http://www.oracle.com/xsl/mapper/schemas" xmlns:dvm="http://www.oracle.com/XSL/Transform/java/oracle.tip.dvm.LookupValue" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes=" xsd oracle-xsl-mapper xsi xsl ns1 ns0 mhdr oraext xp20 xref socket dvm oraxsl"
   ...
   <oracle-xsl-mapper:schema>
      ...
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.4.0(XSLT Build 190828.0353.3300) AT [FRI NOV 18 00:06:16 CST 2022].-->
   </oracle-xsl-mapper:schema>
 ...
 <ns0:InvoiceXML>
              ...
              <ns0:CfdiRelacionados>
                ...
                <xsl:if test="$v_comprobante33/ns1:Comprobante/ns1:CfdiRelacionados/ns1:CfdiRelacionado">
              ...
              <xsl:if test="$v_comprobante33/ns1:Comprobante/ns1:Conceptos/ns1:Concepto">
                <xsl:for-each select="$v_comprobante33/ns1:Comprobante/ns1:Conceptos/ns1:Concepto">
                  ...
                  <xsl:if test="$v_comprobante33/ns1:Comprobante/ns1:Conceptos/ns1:Concepto/ns1:CuentaPredial/@Numero/text()">
                     <ns0:CuentaPredial>
                        <xsl:value-of select="$v_comprobante33/ns1:Comprobante/ns1:Conceptos/ns1:Concepto/ns1:CuentaPredial/@Numero"/>
                     </ns0:CuentaPredial>
                  </xsl:if>
                  <xsl:if test="ns1:InformacionAduanera">
                      <xsl:for-each select="ns1:InformacionAduanera">
