   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="WSDL">
            <oracle-xsl-mapper:schema location="../WSDLs/Orders/SelectDeliverOrders.wsdl"/>
            <oracle-xsl-mapper:rootElement name="SelectDeliverOrdersOutputCollection" namespace="http://xmlns.oracle.com/pcbpel/adapter/db/SelectDeliverOrders"/>
      ...
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [SAT DEC 28 17:38:33 CST 2019].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <ns0:SelectDeliverOrdersOutputCollection>
         <xsl:for-each select="/ns0:SelectDeliverOrdersOutputCollection/ns0:SelectDeliverOrdersOutput">
            <ns0:SelectDeliverOrdersOutput>
