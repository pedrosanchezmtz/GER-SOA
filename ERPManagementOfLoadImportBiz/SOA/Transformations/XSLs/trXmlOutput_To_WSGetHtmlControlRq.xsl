...
<xsl:stylesheet version="1.0" xmlns:ns1="http://soa.estrellaroja.com.mx/ERPManagementOfLoadImportBiz" xmlns:tns="http://soa.estrellaroja.com.mx/SOAUtilitiesTec" xmlns:mhdr="http://www.oracle.com/XSL/Transform/java/oracle.tip.mediator.service.common.functions.MediatorExtnFunction" xmlns:oraext="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.ExtFunc" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xp20="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.Xpath20" xmlns:xref="http://www.oracle.com/XSL/Transform/java/oracle.tip.xref.xpath.XRefXPathFunctions" xmlns:socket="http://www.oracle.com/XSL/Transform/java/oracle.tip.adapter.socket.ProtocolTranslator" xmlns:oracle-xsl-mapper="http://www.oracle.com/xsl/mapper/schemas" xmlns:dvm="http://www.oracle.com/XSL/Transform/java/oracle.tip.dvm.LookupValue" xmlns:ns0="http://soa.estrellaroja.com.mx/ERPManagementOfLoadImportBiz/FndInterfaceControl" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes=" xsd oracle-xsl-mapper xsi xsl ns1 ns0 tns mhdr oraext xp20 xref socket dvm oraxsl"
   ...
   <oracle-xsl-mapper:schema>
      ...
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [TUE JAN 23 22:09:36 CST 2018].-->
   </oracle-xsl-mapper:schema>
   ...
   <xsl:template match="/">
      <tns:GetHtmlControlRq>
         <tns:TotalSucceeded>
            <xsl:value-of select="$inputVariable.SendReportInterfaceRq/ns1:SendReportInterfaceRq/ns1:Files/ns1:LinesNumber - count (/ns0:DATA_DS/ns0:G_HEADER/ns0:LINEID )"/>
         </tns:TotalSucceeded>
         <tns:TotalErrors>
            <xsl:value-of select="count (/ns0:DATA_DS/ns0:G_HEADER/ns0:LINEID )"/>
         </tns:TotalErrors>
         <tns:TotalProcessed>
            <xsl:value-of select="$inputVariable.SendReportInterfaceRq/ns1:SendReportInterfaceRq/ns1:Files/ns1:LinesNumber"/>
         </tns:TotalProcessed>
         <tns:ErrorsDetails>
            <xsl:for-each select="/ns0:DATA_DS/ns0:G_HEADER">
               <tns:ErrorDetail>
                  <tns:DataValue>
