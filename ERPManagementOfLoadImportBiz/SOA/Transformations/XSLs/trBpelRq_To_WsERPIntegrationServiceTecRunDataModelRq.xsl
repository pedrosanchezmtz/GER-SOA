...
<xsl:stylesheet version="1.0"
                ...
                xmlns:tns="http://soa.estrellaroja.com.mx/ERPIntegrationServiceTec"
                xmlns:socket="http://www.oracle.com/XSL/Transform/java/oracle.tip.adapter.socket.ProtocolTranslator"
                xmlns:ns0="http://soa.estrellaroja.com.mx/ERPManagementOfLoadImportBiz"
                ...
                xmlns:plnk="http://docs.oasis-open.org/wsbpel/2.0/plnktype" xmlns:cmn="http://soa.estrellaroja.com.mx/EstrellaRojaCommons"
                ...
                xmlns:ns3="http://xmlns.oracle.com/bruleSendReportInterface/bruleSendReportInterfaceDS"
                xmlns:ns4="http://soa.estrellaroja.com.mx/ERPManagementOfLoadImportBiz/FndInterfaceControl">
    ...
    <tns:RunDataModelRq>
      <tns:reportRequest>
        ...
        <tns:reportAbsolutePath>
          <xsl:value-of select="concat (&quot;/Custom/ER_INTEGRATION/Commons/Data Models/&quot;, &quot;XXER_FND_INTERFACE_CONTROL.xdm&quot; )"/>
        </tns:reportAbsolutePath>
      </tns:reportRequest>
    </tns:RunDataModelRq>
  </xsl:template>
